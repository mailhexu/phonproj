...
Functions:
    generate_supercell: Create supercell from primitive cell
    generate_mode_displacement: Generate displacement patterns for phonon modes
    generate_displaced_supercell: Generate supercell with phonon displacements applied
"""
...
def generate_displaced_supercell(
    ...
    displacements = _get_displacements(
    ...
    # For actual displacement, take real part since positions are real
    displacements_real = displacements.real

    displaced_supercell = copy.deepcopy(supercell)
    positions = displaced_supercell.get_positions()
    positions += displacements_real
    displaced_supercell.set_positions(positions)

    if return_displacements:
        return displaced_supercell, displacements_real
    else:
